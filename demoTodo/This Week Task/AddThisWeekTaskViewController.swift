//
//  AddThisWeekTaskViewController.swift
//  demoTodo
//
...
class AddThisWeekTaskViewController: UIViewController {
    ...
    @IBAction func saveBtn(_ sender: UIButton) {
        ...
        alert.addAction(UIAlertAction(title: "Yes", style: .default, handler: {action in
            ...
            let task = ThisWeekTask(context: self.context)
    ...
    func saveData() {
        do {
            ...
            let _ = try self.context.fetch(ThisWeekTask.fetchRequest())
        }
        catch{
            print("Error")
        }
