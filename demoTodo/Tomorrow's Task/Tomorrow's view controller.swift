//
//  Tomorrow's view controller.swift
//  demoTodo
//
...
class Tomorrow_s_view_controller: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    func fetchData() {
        do {
            self.DBManager = try context.fetch(TomorrowTask.fetchRequest())
...
//        let thisTask: TomorrowTask!
//        thisTask = DBManager[sender.tag]
//        thisTask.isCompleted = sender.isOn
//        do{
...
//    }
    ...
    func tableView(_ tableView: UITableView, leadingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        let edit = UIContextualAction(style: .normal, title: "Edit", handler: { (context, view, actionPerformed: (Bool) -> ()) in
            ...
            self.performSegue(withIdentifier: "editTomorrowViewController", sender: nil)
