//
//  AddEndedTaskViewController.swift
//  demoTodo
//
...
class AddEndedTaskViewController: UIViewController {
    ...
    @IBAction func saveBtn(_ sender: UIButton) {
        ...
        alert.addAction(UIAlertAction(title: "Yes", style: .default, handler: {action in
            ...
            let task = CompletedTask(context: self.context)
    ...
    func saveData() {
        do {
            ...
            let _ = try self.context.fetch(CompletedTask.fetchRequest())
        }
        catch{
            print("Error")
        }
