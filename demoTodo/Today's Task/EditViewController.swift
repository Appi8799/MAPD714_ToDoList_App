...
//            task.name = self.titleLabel.text
//            task.desc = self.descriptionLabel.text
//            task.isCompleted = self.isCompleted.isOn
//            task.hasDueDate = self.hasDueDate.isOn
//
//            if(self.hasDueDate.isOn){
//                task.dueDate = formatter.string(from: self.dueTime.date)
//                task.date = self.dueTime.date
//            }
